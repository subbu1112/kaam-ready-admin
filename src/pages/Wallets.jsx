  ...
  return (
    <div>
      <div style={{ background:C.card, border:'1px solid '+C.border, borderRadius:16, padding:'32px 28px', marginBottom:24 }}>
        <h2 style={{ fontSize:22, fontWeight:800, color:'#fff', marginBottom:6 }}>Wallets</h2>
        <p style={{ color:C.muted, fontSize:14 }}>This section is coming soon. Wallets management features will be available in the next update.</p>
      </div>
