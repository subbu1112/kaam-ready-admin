...
type SlidedownEventName = 'slidedownAllowClick' | 'slidedownCancelClick' | 'slidedownClosed' | 'slidedownQueued' | 'slidedownShown';
...
interface IInitObject {
  ...
  promptOptions?: {
    slidedown: {
      prompts: {
         ...
         */
        categories?: {
          /** Should identify the action. */tag: string; /** What the user will see. */
          label: string;
        }[];
        /**
         ...
         */
        delay: {
          /** The number of pages a user needs to visit before the prompt is displayed. */pageViews?: number; /** The number of seconds a user needs to wait before the prompt is displayed.Both options must be satisfied for the prompt to display */
          timeDelay?: number;
        };
        /**
         ...
         */
        text?: {
          /** The callout asking the user to opt-in. Up to 90 characters. */actionMessage?: string; /** Triggers the opt-in. Up to 15 characters. */
          acceptButton?: string; /** Cancels opt-in. Up to 15 characters. */
          cancelButton?: string; /** The message of the confirmation prompt displayed after the email and/or phone number is provided. Up to 90 characters. */
          confirmMessage?: string; /** Identifies the email text field. Up to 15 characters. */
          emailLabel?: string; /** Cancels the category update. Up to 15 characters. */
          negativeUpdateButton?: string; /** Saves the updated category tags. Up to 15 characters. */
          positiveUpdateButton?: string; /** Identifies the phone number text field. Up to 15 characters. */
          smsLabel?: string; /** A different message shown to subscribers presented the prompt again to update categories. Up to 90 characters. */
          updateMessage?: string;
        };
        /**
  ...
  notifyButton?: {
     ...
     */
    enable?: boolean; /** Specify CSS-valid pixel offsets using bottom, left, and right. */
    offset?: {
      bottom: string;
      left: string;
      right: string;
     ...
     */
    prenotify: boolean; /** Either `bottom-left` or `bottom-right`. The Subscription Bell will be fixed at this location on your page. */
    position?: 'bottom-left' | 'bottom-right'; /**  Set `false` to hide the 'Powered by OneSignal' text in the Subscription Bell dialog popup. */
    showCredit: boolean;
    /**
     ...
     */
    size?: 'small' | 'medium' | 'large'; /** Customize the Subscription Bell text. */
    text: {
...
//#endregion
export { AutoPromptOptions, IDisplayableOSNotification, IInitObject, IOSNotification, IOSNotificationActionButton, IOneSignalAutoPromptOptions, IOneSignalCategories, IOneSignalDebug, IOneSignalNotifications, IOneSignalOneSignal, IOneSignalPushSubscription, IOneSignalSession, IOneSignalSlidedown, IOneSignalTagCategory, IOneSignalUser, NotificationClickEvent, NotificationClickResult, NotificationDismissEvent, NotificationEventName, NotificationEventTypeMap, NotificationForegroundWillDisplayEvent, OneSignalDeferredLoadedCallback, PushSubscriptionNamespaceProperties, SlidedownEventName, SubscriptionChangeEvent, UserChangeEvent, UserNamespaceProperties, OneSignal as default };
